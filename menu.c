...
int menu (void)
{
  SDL_WM_SetCaption("Super Tounsi", NULL);
    ...
    positionFond.x = 0;
    positionFond.y = 0;
    positionnew_game0.x = 50;
    positionnew_game0.y = 240;
    positioncontin0.x = 50;
    positioncontin0.y = 190;
    positioncredits0.x = 50;
    positioncredits0.y = 350;
    positionquit0.x = 50;
    positionquit0.y = 420;
    positionnew_game1.x = 50;
    positionnew_game1.y = 240;
    positioncontin1.x = 50;
    positioncontin1.y = 190;
    positioncredits1.x = 50;
    positioncredits1.y = 350;
    positionquit1.x = 50;
    positionquit1.y = 420;
